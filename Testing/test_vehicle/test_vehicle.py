...
class VehicleTest(TestCase):
    ...
    def test_drive_reduces_ful_when_distance_is_reachable(self):
        distance = 50
    ...
    def test_drive_reduces_ful_with_max_possible_distance(self):
    ...
    def test_refuel_increases_fuel_in_teh_car(self):
        fuel_amount = 20
