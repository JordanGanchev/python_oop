...
class Library:
    ...
    def get_book(self, author: str, book_name: str, days_to_return: int, user: User):
        ...
        for user_book in self.rented_books.values():
            if book_name in user_book:
                return f'The book "{book_name}" is already rented and will be available in {user_book[book_name]} days!'
        # for user_book in self.rented_books.values():
        #     for rented_book_name, days in user_book.items():
