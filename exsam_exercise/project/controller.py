...
class Controller:
    ...
    def sustain(self, player_name: str, sustenance_type: str):
        player = self.__find_name_by_name(player_name)
        if player is None:
            return
    ...
    def duel(self, first_player_name: str, second_player_name: str):
        first_player = self.__find_name_by_name(first_player_name)
        second_player = self.__find_name_by_name(second_player_name)
    ...
    def __find_name_by_name(self, player_name):
        for player in self.players:
